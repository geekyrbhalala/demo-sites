      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            <Link to="/" className="footer-logo">
              <svg viewBox="0 0 48 48" className="footer-logo-icon" aria-hidden="true">
                ...
                <path d="M24 8c-2 3-7 10-7 16a7 7 0 0014 0c0-6-5-13-7-16z" fill="#fff" opacity="0.3"/>
              ...
              <div>
                <span className="footer-brand-name">EVERGREEN</span>
                <span className="footer-brand-sub">LANDSCAPING</span>
              </div>
            </Link>
            <p className="footer-desc">
              Transforming outdoor spaces since 2009. Professional landscaping, garden design, and property maintenance for residential and commercial properties.
            </p>
          ...
          <div className="footer-col">
            <h4>Services</h4>
            <ul>
              <li><Link to="/services">Lawn Maintenance</Link></li>
              <li><Link to="/services">Garden Design</Link></li>
              <li><Link to="/services">Hardscaping</Link></li>
              <li><Link to="/services">Tree Service</Link></li>
              <li><Link to="/services">Irrigation</Link></li>
              <li><Link to="/seasonal">Seasonal Services</Link></li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li><Link to="/estimates">Free Estimate</Link></li>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-contact">
              ...
              <li>
                ...
                <span>(503) 555-TREE<br/>(503) 555-8733</span>
              </li>
              <li>
